        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-2xl shadow-xl p-6 mb-6">
                    <h2 class="font-bold text-3xl text-white leading-tight flex items-center justify-center">
                        <svg class="w-8 h-8 mr-3" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M7 14C5.9 14 5 13.1 5 12S5.9 10 7 10 9 10.9 9 12 8.1 14 7 14M12.65 10C11.83 7.67 9.61 6 7 6C3.69 6 1 8.69 1 12S3.69 18 7 18C9.61 18 11.83 16.33 12.65 14H17V18H21V14H23V10H12.65Z"/>
                        </svg>
                        {{ __('Masuk') }}
                    </h2>
                    <p class="text-indigo-100 mt-2 text-lg">Akses konten premium Anda</p>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="flex items-center">
                            <label for="remember_me" class="inline-flex items-center group cursor-pointer">
                                <input 
                                    ...
                                    name="remember"
                                >
                                <span class="ml-3 text-sm text-gray-600 group-hover:text-gray-800 transition-colors duration-200">{{ __('Remember me') }}</span>
                            </label>
                        </div>
                        ...
                        <div class="flex flex-col space-y-4">
                            ...
                            @if (Route::has('password.request'))
                                <a 
                                    class="text-center underline text-sm text-gray-600 hover:text-indigo-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200" 
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-gray-500">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-800 font-medium transition-colors duration-200">Daftar di sini</a>
                </p>
            </div>
        </div>
    </div>
