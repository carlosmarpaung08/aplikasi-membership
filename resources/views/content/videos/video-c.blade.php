            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="font-bold text-3xl text-white leading-tight flex items-center">
                        ...
                        {{ __('Webinar Eksklusif: Diskusi Tren Masa Depan') }}
                    </h2>
                    <p class="text-purple-100 mt-2 text-lg">Selami wawasan mendalam dari para pemimpin industri</p>
                </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="mb-8">
                <div class="bg-white/60 backdrop-blur-sm rounded-xl px-4 py-3 shadow-sm border border-white/20">
                    <ol class="flex items-center space-x-2 text-sm">
                        ...
                        <li class="text-purple-600 font-medium">Video Tipe C</li>
                    </ol>
                </div>
            </nav>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-3">
                                <span class="bg-white/20 text-white px-3 py-1 rounded-full text-sm font-medium mr-3">Video #3</span>
                            ...
                            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2 leading-tight">
                                Sesi Tanya Jawab dengan CEO
                            </h1>
                            <p class="text-purple-100 text-lg">Wawasan unik langsung dari puncak pimpinan</p>
                        </div>
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 mb-8 border-l-4 border-purple-500">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-gray-800 mb-2">Akses Eksklusif Tipe C</h3>
                                <p class="text-gray-700 leading-relaxed">
                                    Ini adalah rekaman webinar eksklusif bagi anggota <span class="font-bold text-purple-600 bg-purple-100 px-2 py-1 rounded-lg">Tipe C</span>, menampilkan diskusi langsung dengan CEO kami tentang visi perusahaan dan tren industri di masa depan. Anda akan mendapatkan wawasan unik yang tidak tersedia di tempat lain.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="prose prose-lg max-w-none">
                        ...
                        <div class="mb-8">
                            <h3 class="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                                ...
                                Tonton Sesi Eksklusif Ini
                            </h3>
                            
                            <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-6">
                                <p class="text-gray-700 leading-relaxed mb-4">
                                    Sesi tanya jawab ini memberikan kesempatan langka untuk mendapatkan perspektif langsung dari pimpinan tertinggi.
                                </p>
                                <div class="aspect-video w-full bg-gray-200 flex items-center justify-center text-gray-500 rounded-lg overflow-hidden shadow-lg border border-gray-300">
                                    ...
                                    {{-- <p class="text-lg font-semibold">Simulasi Video Player untuk Sesi Eksklusif Tipe C</p> --}}
                        ...
                        <div class="mb-8">
                            ...
                            <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-6">
                                <p class="text-gray-700 leading-relaxed mb-4">
                                    Dalam sesi ini, dibahas topik-topik krusial seperti:
                                </p>
                                
                                <!-- Discussion Points List -->
                                <ul class="list-none p-0 m-0 space-y-3">
                                    <li class="flex items-center p-3 bg-purple-50 rounded-xl">
                                        ...
                                        <span class="font-medium text-purple-800">Visi Jangka Panjang Perusahaan</span>
                                    </li>
                                    <li class="flex items-center p-3 bg-pink-50 rounded-xl">
                                        <div class="w-6 h-6 bg-pink-500 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                            <svg class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                            </svg>
                                        </div>
                                        <span class="font-medium text-pink-800">Inovasi dan Teknologi Terbaru</span>
                                    </li>
                                    <li class="flex items-center p-3 bg-indigo-50 rounded-xl">
                                        <div class="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                                            <svg class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                            </svg>
                                        </div>
                                        <span class="font-medium text-indigo-800">Dampak Industri & Prediksi</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            <h3 class="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                                ...
                                Lanjutkan Eksplorasi Konten Eksklusif
                            </h3>
                            
                            <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-200">
                                <p class="text-gray-700 leading-relaxed mb-4">
                                    Jangan lewatkan wawasan berharga lainnya. Jelajahi seluruh perpustakaan konten eksklusif yang tersedia untuk anggota Tipe C.
                                </p>
                                ...
                                <div class="flex items-center justify-between bg-white rounded-xl p-6 shadow-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="font-bold text-gray-800">Jelajahi Semua Konten Eksklusif</p>
                ...
                <div class="bg-gray-50 px-8 py-6 border-t border-gray-100">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <em>Video ini hanya dapat diakses oleh member Tipe C</em>
                        </div>
            ...
            <div class="mt-8 grid md:grid-cols-3 gap-4">
                ...
                <div class="bg-white/60 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/20 hover:shadow-md transition-all duration-200 cursor-pointer hover:bg-white/80">
                    ...
                    <a href="{{ route('video.tipe-b') }}" class="text-purple-700 text-sm mt-1 font-medium block">Menganalisis Data Pengguna</a>
                </div>

                <!-- Current Position -->
                <div class="bg-purple-500 rounded-xl p-4 shadow-lg text-white text-center">
                    <p class="font-semibold">Video 3 dari 3</p>
